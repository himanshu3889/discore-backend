module github.com/himanshu3889/discore-backend
...
require (
	...
	github.com/gin-gonic/gin v1.11.0 // HTTP/WebSocket router
	...
	golang.org/x/crypto v0.46.0 // CRYPTO
)

require (
	github.com/elastic/go-elasticsearch/v8 v8.19.3 // Elastic search client
	github.com/failsafe-go/failsafe-go v0.6.7 // Bulkhead, timeout, retry
	...
	golang.org/x/sync v0.19.0 // Singleflight, errgroup
)
...
require (
	...
	github.com/culionbear/lokirus v1.0.5 // indirect
